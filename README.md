...
### Now for the API CONTROL we are Creating a folder name as "Model"<br>

- Here we will create another file named as user.js in the model folder, attaching the picture of root hierarchy below:
